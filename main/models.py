...
class Category(models.Model):
    ...
    eng_name = models.CharField(
        max_length=60, null=True, verbose_name="الاسم باللغة الانجليزية"
    )
...
class Post(models.Model):
    ...
    Egyptian_student = models.IntegerField(
        null=True, blank=True, verbose_name="طالب مصري"
    )
    Foreign = models.IntegerField(null=True, blank=True, verbose_name="أجنبي")
    Foreign_student = models.IntegerField(
        null=True, blank=True, verbose_name="طالب أجنبي"
    )

    open_time = models.TimeField(
        auto_now=False, auto_now_add=False, null=True, blank=True, verbose_name="يفتح"
    )
    closing_time = models.TimeField(
        auto_now=False, auto_now_add=False, null=True, blank=True, verbose_name="يغلق"
    )
